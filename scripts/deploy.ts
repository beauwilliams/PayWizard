...
async function main() {
  ...
  let deployments = `
  export const TOKEN_CONTRACT_ADDRESS: string = "${token.address}"
  export const VESTING_CONTRACT_ADDRESS: string = "${vesting.address}"
  export const ALLOCATION_CONTRACT_ADDRESS: string = "${allocation.address}"
  `
